...
define(
	function (require) {
		...
		return React.createClass(
			{
				displayName: 'Widget.Payment.Method.Bill',
				mixins: [
					Behavior.Base
				],
				...
				submit: function (event, data) {
					return Util.Checkout.Order.create.bill(
						data.agreement
					).intercept(
						function (status) {
							...
							if(this.refs.hasOwnProperty('bill-form')){
								refsForm = this.refs['bill-form'].serialize.call(this.refs['bill-form']);
								if(_.size(refsForm)){
